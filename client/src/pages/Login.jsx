      ...
      if (formData.email && formData.password) {
        const user = {
          ...
          role: formData.email.includes('admin') ? 'admin' : 
                formData.email.includes('ngo') ? 'ngo' : 
                formData.email.includes('volunteer') ? 'volunteer' : 'donor'
        };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 p-4 sm:p-6">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <Link to="/register" className="text-sm text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
        ...
        >
          <div className="card glass p-8">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-dark-50 text-gray-500">
                  or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="glass" className="w-full">
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.13-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.63l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
          ...
          <div className="mt-6 p-4 rounded-xl bg-accent/10 border border-accent/20">
            ...
            <ul className="text-xs text-accent-700 space-y-1">
              <li>Admin: admin@demo.com | NGO: ngo@demo.com</li>
              <li>Volunteer: volunteer@demo.com | Donor: donor@demo.com</li>
              <li>Password: any password works</li>
            </ul>
          </div>
        </motion.div>
      </div>
